...
*	Version: 1.0.3
*/
jQuery(document).ready(function($){"use strict";var i,t=".wrapper",e=".side-navigation-wrapper",n="#side-nav-show a",a="#side-nav-hide a",s=".reveal-side-navigation",o=".element-reveal-left",c=".element-reveal-right",r=".element-show-left",d=".element-show-right",l=".side-nav-open",u=".content-side-navigation-screen",v=500,h="easeInOutQuint",f={init:function(){$("body").data("aux-nav",!1);var i,m=$(e).hasClass("enter-right")?"right":"left";Y?i="left"===m?o:c:(i="left"===m?r:d,$(e).addClass("hide")),i=i.split(".").join(""),l=l.split(".").join(""),$(n).on("click",function(n){if(n.preventDefault(),$(e).hasClass("active"))f.closeNav(i);else{N.state(!0),$("body").data("aux-nav",!0),Y?($(s).addClass(i).css({transitionDuration:v+"ms",transitionTimingFunction:tt[h]}),$(e).addClass("active").css({transitionDuration:v+"ms",transitionTimingFunction:tt[h]}),$("body").addClass(l)):($(t).addClass(i),$(e).removeClass("hide").addClass("active")),I.state(!0),$(e).on(it,function(i){return i.target!==$(this)[0]?!1:(i.stopPropagation(),void $(this).off(it))});var a=$('<a href="#" />').addClass(u.split(".").join("")).appendTo($(t));$(a).on("click",function(t){t.preventDefault(),f.closeNav(i)}),$(a).swipeIt({preventTouchOn:e,onSwipeEnd:function(t){"right"===m?"left"===t&&f.closeNav(i):"right"===t&&f.closeNav(i)}})}}),$(a).on("click",function(t){t.preventDefault(),f.closeNav(i)}),$(window).on("resize",function(){I.state($("body").data("aux-nav")?!0:!1)})},closeNav:function(i){Y?(N.state(!0),$(s).removeClass(i),$(e).removeClass("active"),$(e).on(it,function(i){return i.target!==$(this)[0]?!1:(i.stopPropagation(),I.state(!1),$(this).off(it),void $("body").removeClass(l))})):($(t).removeClass(i),$(e).addClass("hide").removeClass("active")),$("body").data("aux-nav",!1),$(t).find(u).remove()}},m=".overlay-navigation-wrapper",p=".overlay-navigation-inner",b="#overlay-nav-show a",g="#overlay-nav-hide a",C=500,y="easeInOutQuint",w={init:function(){$(b).on("click",function(i){i.preventDefault(),$(m).hasClass("active")?w.closeNav():($("body").data("aux-nav",!0),$(m).addClass("active").css(Y?{top:0,transitionDuration:C+"ms",transitionTimingFunction:tt[y]}:{top:0}),$(m).on(it,function(i){return i.target!==$(this)[0]?!1:(i.stopPropagation(),I.state(!0),void $(this).off(it))}))}),$(p).on("click",function(i){i.target===this&&w.closeNav()}),$(g).on("click",function(i){i.preventDefault(),w.closeNav()}),$(window).on("resize",function(){I.state($("body").data("aux-nav")?!0:!1)})},closeNav:function(){Y?($(m).removeClass("active"),$(m).on(it,function(i){return i.target!==$(this)[0]?!1:(i.stopPropagation(),I.state(!1),$(m).css({top:"-100%"}),void $(this).off(it))})):$(m).removeClass("active").css({top:"-100%"}),$("body").data("aux-nav",!1)}},z=".side-navigation-wrapper, .overlay-navigation-wrapper",T=".sub-menu",k=".contains-sub-menu",O={init:function(){$(z).find(k).each(function(){$(this).on("click",function(i){i.preventDefault(),N.state(!0);var t=$(this).siblings(T).children(),e=0;t.each(function(){e+=$(this).outerHeight()}),$(this).siblings(T).hasClass("open")?$(this).closest(z).find(T).css({height:0}).removeClass("open"):($(this).closest(z).find(T).css({height:0}).removeClass("open"),$(this).siblings(T).css({height:e+"px"}),$(this).siblings(T).addClass("open"))})})}},I={state:function(i){et?i?$("body").addClass("aux-navigation-active"):$("body").removeClass("aux-navigation-active"):i?$("body").addClass("aux-navigation-active"):$("body").data("aux-nav")||$("body").removeClass("aux-navigation-active")}},x=".header, .header-inner, .header .logo, .header .navigation, .reveal-side-navigation, .side-navigation-wrapper",N={init:function(){et||$(window).on("scroll",function(){N.state(!0)}),$(window).on("resize",function(){N.state(!1)})},state:function(i){i?$(x).removeClass("no-transition"):$(x).addClass("no-transition")}},E=300,D=".scroll-to-top",Q=600,B={init:function(){$(window).on("scroll",function(){return $(D).is("[data-no-hide]")?!1:void($(this).scrollTop()>E?$(D).fadeIn(Q):$(D).fadeOut(Q))}),$(D).on("click",function(i){i.preventDefault(),B.scrollUp()})},scrollUp:function(){$("html, body").animate({scrollTop:0},Q)}},P=".tabs",A=".accordion",F="icon-plus",S="icon-minus",H=".accordion-content",M=".box.dismissable",W=300,j="swing",L=".dropdown",R=".thumbnail",U=".overlay-info, img",q=".overlay-info",G=400,J="easeInOutQuint",K={init:function(){K.tabs(),K.accordions(),K.dismissable(),K.dropdown(),K.rollovers(),K.thumbnailRatio()},tabs:function(){$(P).each(function(){var i=$(this).find("li a");$(this).find(".tab-panes .active").addClass("fade-in"),i.each(function(){$(this).on("click",function(){var i=$(this).attr("href"),t=$(this).closest(".tabs").find(i);$(this).closest(".tab-nav").find(".active").removeClass("active"),$(this).parent().addClass("active"),$(this).closest(".tabs").find(".tab-panes .active").removeClass("active fade-in"),t.addClass("active");var e=null;return clearTimeout(e),e=setTimeout(function(){t.addClass("fade-in")},50),!1}),$(this).parent().hasClass("active")&&$(this).closest(".tabs").find($(this).attr("href")).addClass("active")})})},accordions:function(){$(A).each(function(){var i=$(this).find("li a");i.each(function(){$(this).closest(A).is("[data-toggle-icon]")&&($(this).find("span").length||$(this).parent().hasClass("active")?!$(this).find("span").length&&$(this).parent().hasClass("active")&&$(this).prepend('<span class="'+S+'" />'):$(this).prepend('<span class="'+F+'" />')),$(this).on("click",function(){var i=$(this),t=i.attr("href"),e=i.closest(A).find(t),n=i.closest(A).find("li > div");i.closest(A).find("li.active > div").each(function(){var i=$(this).children().outerHeight();$(this).addClass("no-transition").css({height:i+"px"})});var a=null;return clearTimeout(a),a=i.parent().hasClass("active")?setTimeout(function(){i.closest(A).is("[data-toggle-multiple]")?i.siblings(e).removeClass("no-transition").css({height:0}):i.closest(A).find("li.active > div").removeClass("no-transition").css({height:0}),i.parent().removeClass("active")},50):setTimeout(function(){var t=i.siblings(e).find(H).outerHeight();i.closest(A).is("[data-toggle-multiple]")||(n.removeClass("no-transition").css({height:0}),i.closest(A).find("li").removeClass("active")),i.parent().addClass("active"),i.siblings(e).removeClass("no-transition").css({height:t+"px"})},50),i.find("."+S).length?i.find("."+S).removeClass(S).addClass(F):i.find("."+F).length&&(i.closest(A).is("[data-toggle-multiple]")||i.closest("ul").find("."+S).removeClass(S).addClass(F),i.find("."+F).removeClass(F).addClass(S)),!1})}),$(window).on("resize",function(){$(A).each(function(){$(this).find("li.active > div").addClass("no-transition").css({height:"auto"})})})})},dismissable:function(){$(M).each(function(){$(this).find(".close").length||$(this).prepend('<a href="" class="close icon-cancel" />'),$(this).find(".close").on("click",function(i){i.preventDefault(),Y?$(this).parent().css({transitionProperty:"opacity",opacity:0,transitionDuration:W+"ms",transitionTimingFunction:tt[j]}).on(it,function(i){return i.stopPropagation(),i.target!==$(this)[0]?!1:void $(this).remove()}):$(this).parent().animate({opacity:0},G,j,function(){$(this).remove()})})})},dropdown:function(){$(L).each(function(){$(this).find(".button, button").each(function(){$(this).on("click",function(i){i.preventDefault();var t=$(this).parent().children(".dropdown-list");return $(this).parent().hasClass("disabled")?!1:($(".dropdown-list").not($(t)).removeClass("active"),void($(t).hasClass("active")?$(t).removeClass("active"):$(t).addClass("active")))}),$(this).parent().children(".dropdown-list").find("li a").on("click",function(i){i.preventDefault(),$(".dropdown-list").removeClass("active")})})})},rollovers:function(){Y?$(R).each(function(){var i,t=$(this).data("hover-speed")?$(this).data("hover-speed"):G,e=$(this).data("hover-easing")?$(this).data("hover-easing"):J,n=$(this).data("hover-bkg-opacity")?$(this).data("hover-bkg-opacity"):1;if($(this).data("hover-bkg-color")){var a=$(this).data("hover-bkg-color");a=a.replace("#","");var s=parseInt(a.substring(0,2),16),o=parseInt(a.substring(2,4),16),c=parseInt(a.substring(4,6),16);i="rgba( "+s+","+o+","+c+","+n/1+" )"}else i=$(this).find(q).css("background-color");$(this).find(U).css({transitionDuration:t+"ms",transitionTimingFunction:tt[e]}),$(this).find(q).css({backgroundColor:i})}):$(R).find(".overlay-link").mouseenter(function(){$(this).find(q).css({opacity:0}).stop().animate({opacity:1},G,J)}).mouseleave(function(){$(this).find(q).stop().animate({opacity:0},G,J)})},thumbnailRatio:function(){$(window).on("resize",function(){$(R).each(function(){if($(this).find(".caption-over-outer").length){var i=$(this).find("img"),t=i.attr("width"),e=i.attr("height"),n=$(this).find("img").width(),a=e>t?e/t:t/e,s=e>t?n*a:n/a;$(this).find(".caption-over-outer").css({opacity:1}),$(this).css({height:s+"px"})}})}).resize()}},V=document.body||document.documentElement,X=V.style,Y=void 0!==X.transition||void 0!==X.WebkitTransition||void 0!==X.MozTransition||void 0!==X.MsTransition||void 0!==X.OTransition,Z=["WebkitTransform","MozTransform","OTransform","msTransform"];for(var _ in Z)void 0!==X[Z[_]]&&(i="-"+Z[_].replace("Transform","").toLowerCase());var it="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend";Y&&(document.getElementsByTagName("body")[0].className+=" transition-support");var tt={linear:"cubic-bezier(0, 0, 1, 1)",swing:"cubic-bezier(0.42, 0, 0.58, 1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)"};window.onpageshow=function(i){i.persisted&&$("body").addClass("page-fade-reset").removeClass("page-fade-out")};var et=!1;(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))&&(et=!0,document.getElementsByTagName("body")[0].className+=" mobile");var nt="WebkitAppearance"in document.documentElement.style;nt&&(document.getElementsByTagName("body")[0].className+=" webkit");var at=/constructor/i.test(window.HTMLElement);at&&(document.getElementsByTagName("body")[0].className+=" safari-browser");var st=document.all&&document.addEventListener||"-ms-scroll-limit"in document.documentElement.style&&"-ms-ime-align"in document.documentElement.style;st&&(document.getElementsByTagName("body")[0].className+=" ie-browser"),f.init(),w.init(),O.init(),N.init(),B.init(),K.init()});
/**
*	Avalanche Slider
*	Version: 1.0.3
*/
!function(a,t,e,i){"use strict";function n(t){t.find(".tms-caption").each(function(){var t=a(this),e=(t.data("animate-in")+"").split(";");a.each(e,function(a,e){e=e.split(":");var i=e[0],n=e[1];"opacity"===i&&t.data("o",n),"scale"===i&&t.data("s",n),"easing"===i&&t.data("e",n),"transX"===i&&t.data("tx",parseFloat(n)),"transY"===i&&t.data("ty",parseFloat(n)),"transZ"===i&&t.data("tz",parseFloat(n)),"rotateX"===i&&t.data("rx",parseFloat(n)),"rotateY"===i&&t.data("ry",parseFloat(n)),"rotateZ"===i&&t.data("rz",parseFloat(n)),"duration"===i&&t.data("du",parseFloat(n)),"delay"===i&&t.data("de",parseFloat(n))}),t.data("w",parseFloat(t.css("width"))),t.data("h",parseFloat(t.css("height"))),t.data("fs",parseFloat(t.css("font-size"))),t.data("lh",parseFloat(t.css("line-height"))),t.data("pt",parseFloat(t.css("padding-top"))),t.data("pr",parseFloat(t.css("padding-right"))),t.data("pb",parseFloat(t.css("padding-bottom"))),t.data("pl",parseFloat(t.css("padding-left"))),t.data("mt",parseFloat(t.css("margin-top"))),t.data("mr",parseFloat(t.css("margin-right"))),t.data("mb",parseFloat(t.css("margin-bottom"))),t.data("ml",parseFloat(t.css("margin-left"))),t.data("bt",parseFloat(t.css("border-top-width"))),t.data("br",parseFloat(t.css("border-right-width"))),t.data("bb",parseFloat(t.css("border-bottom-width"))),t.data("bl",parseFloat(t.css("border-left-width")))})}function s(t,i,n){var s=t.find(".tms-slide"),o=0;s.each(function(){{var s=a(this),d=s.find("img").length,l=s.find("iframe, video").length;s.children(".tms-caption").length}m(s,i);var c=a('<div class="tm-loader"><div id="circle" /></div>');if(d>0&&(i.lazyLoad?c.appendTo(s):t.find(c).length||c.appendTo(t)),l){I&&s.is("[data-video-bkg]")&&s.children("video").css({display:"none"});var u=s.find("iframe, video");x(u,i),f(s,i),p(t,i)}d?s.find("img").each(function(t,l){l=a(this).data("src");var c=l.substr(l.lastIndexOf("."));(e.isRetinaDevice()&&i.retinaSupport||e.isRetinaDevice()&&a(this).is("[data-retina]"))&&(!I&&!i.retinaSupportMobile||I&&i.retinaSupportMobile)&&(l.match(/\.(svg)/i)||(l=a(this).data("src").replace(c,i.retinaSuffix+c))),a(this).css({opacity:0}).attr("src",l).one("load",function(){a(this).data("loaded",!0).css({opacity:1}),t++,t===d&&(o++,r(s,o,i,n))}).one("error",function(){console.log("Error src:"+l)})}):(o++,f(s,i),p(t,i),r(s,o,i,n))})}function r(a,t,e,i){var n=a.closest(".tm-slider-container"),s=n.find(".tms-slides"),r=n.find("li.active"),o=null,d=null;if(a.find(".no-transition").css({visibility:"visible"}),0===n.height()&&a.hasClass("active")){r.children("img").css({maxHeight:"none"});var l=r.children("img").height();n.data("refH",l),n.css({height:l+"px"}),r.children("img").css({maxHeight:"100%"})}if(f(a,e),p(n,e),e.carousel&&!e.lazyLoad&&(s.children().css({opacity:1}),s.css({opacity:0})),n.find("iframe, video").css({opacity:1}),t===s.children().length&&e.onLoadEnd&&e.onLoadEnd(),e.lazyLoad||t!==s.children().length?e.lazyLoad&&1===t&&(n.data("loaded",!0),e.autoAdvance&&i.initSlideshow()):(n.data("loaded",!0),e.autoAdvance&&i.initSlideshow()),e.lazyLoad){if(a.find(".tm-loader").length&&a.find(".tm-loader").remove(),(a.is(r)||e.carouselVisible>1)&&a.find(".tms-caption").show(),!a.hasClass("active"))return!1;C?(r.css({transition:"none",opacity:0}),clearTimeout(d),d=setTimeout(function(){r.css({transitionProperty:"opacity",transitionDuration:"700ms",opacity:1})},50)):a.animate({opacity:1}),clearTimeout(o),o=setTimeout(function(){c(r,e)},300),e.carouselScaleHeight&&n.css("height","auto")}else t===s.children().length&&(n.find(".tm-loader").length&&n.find(".tm-loader").remove(),r.find(".tms-caption").show(),e.carouselVisible>1&&n.find(".tms-caption").show(),C?e.carousel?s.css({transitionProperty:"opacity",transitionDuration:"700ms",opacity:1}):r.css({transitionProperty:"opacity",transitionDuration:"700ms",opacity:1}):e.carousel?s.animate({opacity:1}):r.animate({opacity:1}),clearTimeout(o),o=setTimeout(function(){c(r,e)},300),n.find(".tms-arrow-nav, .tms-pagination").css({display:"block"}),e.carouselScaleHeight&&n.css("height","auto"))}var o=function(r,o){var c=a.extend({},a.fn.avalancheSlider.tmsOpts,o),v=a(r),g=this;c.scaleUnder=v.data("scale-under")?v.data("scale-under"):c.scaleUnder;var b=c.fulscreen?a(e).width():c.fullwidth?c.scaleUnder:parseFloat(v.css("width")),y=c.fulscreen?a(e).height():parseFloat(v.css("height"));v.data("transitioning",!1).data("setup",!1).data("loaded",!1).data("refW",b).data("refH",y).data("carousel-height",y),n(v);var w=v.find("li:first-child").addClass("active");c.lazyLoad||w.css({opacity:0}),f(w,c),p(v,c);var x=v.find(".tms-slides"),z=[];if(x.children(".tms-slide").each(function(t){t++,a(this).attr("id","tms-slide-"+t),z.push(a(this).attr("id")),c.carousel||a(this).not(".active").css(C?{transition:"none",transform:"translate3d( 100%, 0, 0)"}:{left:"100%"}),(c.forceFit||a(this).is("[data-force-fit]"))&&a(this).addClass("tms-forcefit")}),I&&(c.autoPlay=!1,c.useVideoAPI=!1),c.fullscreen&&(v.css({top:0,left:0}).addClass("tms-fullscreen"),c.carouselVisible=1),c.captionScaling||v.addClass("tms-caption-no-scaling"),!c.carousel&&c.carouselVisible&&(c.carouselVisible=1),c.carouselVisible>1&&(c.animation="slide"),c.carousel&&v.addClass("tms-carousel"),c.navArrows&&x.children().length>1){var T=a('<a href="#" />').attr("id","tms-prev").addClass("tms-arrow-nav").appendTo(v),F=a('<a href="#" />').attr("id","tms-next").addClass("tms-arrow-nav").appendTo(v);T.each(function(){a(this).on("click",function(a){a.preventDefault(),c.autoAdvance&&v.data("loaded")&&g.resetSlideshow(),g.prevSlide()})}),F.each(function(){a(this).on("click",function(a){a.preventDefault(),c.autoAdvance&&v.data("loaded")&&g.resetSlideshow(),g.nextSlide()})}),c.lazyLoad&&v.find(".tms-arrow-nav").css({display:"block"})}if(c.navPagination&&x.children().length>1){for(var P=a("<div>").addClass("tms-pagination").appendTo(v),A=1;A<x.children().length+1;A++)v.find(P).append('<a href="#" id="tms-pagination-'+A+'" data-index="'+A+'" class="tms-bullet-nav" />');var O=v.find("bullets"===c.paginationType?".tms-bullet-nav":".tms-thumb-nav");O.each(function(){a(this).on("click",function(){return w=v.find("li.active"),a(this).hasClass("active")?!1:(c.autoAdvance&&v.data("loaded")&&g.resetSlideshow(),parseFloat(a(this).data("index"))>parseFloat(P.find(".active").data("index"))?g.slideTo(a(this).data("index"),"next"):g.slideTo(a(this).data("index"),"prev"),!1)})}),P.find(".tms-bullet-nav:first-child").addClass("active"),c.lazyLoad&&P.css({display:"block"})}if(c.navShowOnHover&&v.addClass("show-on-hover"),c.navKeyboard&&x.children().length>1){var V=[];a(t).on("keydown",function(a){return V[a.keyCode]=!0,V[37]&&V[39]?!1:(V[37]?(c.autoAdvance&&v.data("loaded")&&g.resetSlideshow(),c.lazyLoad?g.prevSlide():v.data("loaded")&&g.prevSlide()):V[39]&&(c.autoAdvance&&v.data("loaded")&&g.resetSlideshow(),c.lazyLoad?g.nextSlide():v.data("loaded")&&g.nextSlide()),i)}).on("keyup",function(a){V[a.keyCode]=!1})}v.swipeIt({draggable:!1,onSwipeMove:function(){},onSwipeEnd:function(a){"left"===a?g.prevSlide():g.nextSlide()}}),a(e).on("resize",function(){w=v.find("li.active"),c.carousel&&c.carouselVisible>1?x.children(".tms-slide").each(function(){f(a(this),c)}):f(w,c),c.carouselScaleHeight&&v.css("height","auto"),p(v,c),v.addClass("resizing"),S(function(){v.removeClass("resizing")},300,"resize")}),c.onSetup&&c.onSetup(),v.data("setup",!0);var M,E,k,B,D,L,W,Q=null,R=null;g.initSlideshow=function(){return M||x.children().length<2?!1:(c.autoAdvance=!0,!I&&c.pauseOnHover&&(x.on("mouseleave ",g.resumeSlideshow),x.on("mouseenter ",g.pauseSlideshow)),c.showProgressBar&&(W=a("<div>").addClass("tms-progress-bar").appendTo(v)),g.startSlideshow(),N(c.interval),E=(new Date).getTime(),D=c.interval,c.onSlideshowStart&&c.onSlideshowStart(),i)},g.startSlideshow=function(a){a=a?B:c.interval,M=setInterval(function(){a!==c.interval&&(clearInterval(M),a=c.interval,D=c.interval,g.startSlideshow()),E=(new Date).getTime(),i!==W&&W.css({transition:"none",width:"0px"}),N(c.interval),g.nextSlide()},a)},g.pauseSlideshow=function(){return L||!M?!1:(clearInterval(M),k=(new Date).getTime(),B=50>D-(k-E)?50:D-(k-E),D=0===D?c.interval:B,i!==W&&W.stop().css({width:W.width()+"px"}),L=!0,c.onSlideshowPause&&c.onSlideshowPause(),i)},g.resumeSlideshow=function(){return L?(clearInterval(M),v.data("ssPaused",!1),E=(new Date).getTime(),N(B),g.startSlideshow(B),L=!1,i):!1},g.resetSlideshow=function(){return M?(clearInterval(M),i!==W&&W.css({transition:"none",width:"0px"}),N(c.interval),E=(new Date).getTime(),B=c.interval,D=c.interval,g.startSlideshow(c.interval),i):!1},g.endSlideshow=function(){return M?(clearInterval(M),M="",L=!1,!I&&c.pauseOnHover&&(x.off("mouseleave ",g.resumeSlideshow),x.off("mouseenter ",g.pauseSlideshow)),i!==W&&W.remove(),c.onSlideshowEnd&&c.onSlideshowEnd(),i):!1};var N=function(a){return i===W?!1:(C?(clearTimeout(Q),Q=setTimeout(function(){W.css({transitionProperty:"width",width:"100%",transitionDuration:a+"ms",transitionTimingFunction:"ease"})},50)):W.stop(!0,!0).animate({width:"100%"},a),i)};g.nextSlide=function(){if(v.data("transitioning"))return!1;var t;w=v.find("li.active");var e=z[a.inArray(w.attr("id"),z)+1];if(t=a.inArray(e,z)+1===0?1:a.inArray(e,z)+1,c.carousel&&c.carouselVisible>1){var i=h(v,c);1!==i&&(t=t===x.children().length-(i-2)?1:a.inArray(e,z)+1)}this.slideTo(t,"next")},g.prevSlide=function(){if(v.data("transitioning"))return!1;var t;w=v.find("li.active");var e=z[a.inArray(w.attr("id"),z)-1];if(t=a.inArray(e,z)+1===0?x.children().length:a.inArray(e,z)+1,c.carousel&&c.carouselVisible>1){var i=h(v,c);t=t===x.children().length?x.children().length-(i-1):a.inArray(e,z)+1}this.slideTo(t,"prev")},g.slideTo=function(t,e){if(e||(w=v.find("li.active")),v.data("transitioning")||t===a.inArray(w.attr("id"),z)+1)return!1;u(v,t);var i=v.width(),n="slide"===c.animation?i:0;n*=c.carousel?t-1:1;var s=v.find("#tms-slide-"+t);s.addClass("target").css({zIndex:2,opacity:0===n?0:1}),w.css({zIndex:1}),m(s,c),s.children("img").data("loaded")&&f(s,c),p(v,c),e||(e="next"),e=c.carousel?1:"next"===e?1:-1;var r=h(v,c);C?c.carousel?d(x,1,-(n/r)*e,0,0,0,0,0,1,c.speed,0,H[c.easing],c):(s.css({transition:"none",transform:"translate3d("+n*e+"px, 0, 0)"}),clearTimeout(R),R=setTimeout(function(){d(w,1,-n*e,0,0,0,0,0,1,c.speed,0,H[c.easing],c),d(s,1,0,0,0,0,0,0,1,c.speed,0,H[c.easing],c)},50)):c.carousel?(v.data("transitioning",!0),x.animate({opacity:1,left:-(n/r)*e+"px"},c.speed,c.easing,function(){l(v,c)})):(v.data("transitioning",!0),s.css({left:i*e+"px",visibility:"visible"}).animate({opacity:1,left:"0px"},c.speed,c.easing,function(){l(v,c)}),w.animate({left:-i*e+"px"},c.speed,c.easing))},s(v,c,g)},d=function(t,e,i,n,s,r,o,d,c,u,h,p,f){var v=t.closest(".tm-slider-container");(t.hasClass("active")||t.hasClass("target")||t.hasClass("tms-slides"))&&(v.data("transitioning",!0),f.onSlideBefore&&f.onSlideBefore());var m={};m.transform="translate3d("+i+"px, "+n+"px, "+s+"px)rotate3d( 1, 0, 0, "+r+"deg)rotate3d( 0, 1, 0, "+o+"deg)rotate3d( 0, 0, 1, "+d+"deg)scale3d("+c+", "+c+", "+c+")",m.transitionProperty=O+", opacity",m.transitionDuration=u+"ms",m.transitionDelay=h+"ms",m.transitionTimingFunction=p,m.visibility="visible",m.opacity=e,t.css(m).on(V,function(t){t.stopPropagation(),a(this).off(V),(a(this).hasClass("target")||a(this).hasClass("tms-slides"))&&l(v,f),a(this).hasClass("tms-caption")&&a(this).css({transition:""})})},l=function(a,t){a.data("transitioning",!1),t.onSlideAfter&&t.onSlideAfter();var e=a.find("li.active"),n=a.find("li.target");return g(e,"pause",t),1===t.carouselVisible&&e.find(".tms-caption").not(".no-transition").css({display:"none",visibility:"hidden"}),t.carousel||e.css({visibility:"hidden"}),e.removeClass("active"),n.removeClass("target").addClass("active"),e=n,g(e,"play",t),t.carouselVisible>1?!1:(c(e,t),i)},c=function(t,e){t.find(".tms-caption").not(".no-transition").show().each(function(){var t=a(this),i=a(this).data("du")?t.data("du"):e.speed,n=a(this).data("de")?t.data("de"):0,s=a(this).data("e")?H[t.data("e")]:H[e.easing],r=null;C?(clearTimeout(r),r=setTimeout(function(){d(t,1,0,0,0,0,0,0,1,i,n,s)},500)):(s=t.data("e")?t.data("e"):e.easing,t.delay(n).css({visibility:"visible"}).animate({opacity:1},i,s))})},u=function(a,t){var e=a.find(".tms-pagination");e.find(".active").removeClass("active"),e.find("#tms-pagination-"+t).addClass("active")},h=function(t,i){var n;return n=a(e).width()<768||a(e).width()>959||i.carouselVisible<=3?a(e).width()<480||a(e).width()>767||i.carouselVisible<=2?a(e).width()>479?i.carouselVisible:1:2:3},p=function(t,e){if(!e.carousel)return!1;var i,n,s=t.find(".tms-slides"),r=t.find("li.active"),o=r.index(),d=t.find(".tms-pagination"),l=s.children().length,c=h(t,e),p=t.width()/c,f=0,v=null;s.css({overflow:"visible"}).children().each(function(t){e.carouselVisible=0===e.carouselVisible?1:e.carouselVisible,1===e.carouselVisible?(a(this).css(C?{width:p+"px",opacity:1,visibility:"visible",transform:"translate3d("+p*t+"px, 0, 0)"}:{width:p+"px",opacity:1,visibility:"visible",left:p*t+"px"}),t++):a(this).css({width:p+"px",opacity:1,visibility:"visible","float":"left",position:"relative"}),f=f>a(this).outerHeight()?f:a(this).outerHeight()}),2===c&&o>s.children().length-2?(i=s.children().length-1,n=!0):3===c&&o>s.children().length-3?(i=s.children().length-2,n=!0):o>s.children().length-c?(i=s.children().length-c+1,n=!0):(i=o,n=!1),d.children().hide().slice(0,s.children().length-c+1).show(),n&&(r.removeClass("active"),s.find("li:nth-child("+i+")").addClass("active"),u(t,i)),e.carouselScaleHeight&&t.css({height:f+"px"}),C?(t.data("transitioning")||s.css({width:p*l+"px",transition:"none",transform:"translate3d("+-(p*i)+"px, 0, 0)"}),clearTimeout(v),v=setTimeout(function(){s.css({transitionProperty:"opacity, "+O,transitionDuration:e.speed+"ms"})},50)):s.css({width:p*l+"px",left:-(p*i)+"px"})},f=function(t,i){var n=t.closest(".tm-slider-container"),s=n.parent().width(),r=n.data("refW"),o=n.data("refH"),d=i.fullscreen?a(e).width()/a(e).height():r/o,l=n.data("external-padding")?parseFloat(n.data("external-padding")):i.externalPadding,c=i.fullscreen||i.fullwidth?a(e).width()-l:s,u=i.fullscreen?a(e).height()-l:i.carousel&&i.carouselVisible>1&&!i.carouselScaleHeight?o:i.fullwidth&&s/d>o?o-l:s/d-l,h=c/u;if(n.data("newSW",c),n.data("newSH",u),i.carousel&&i.carouselVisible>1&&i.carouselScaleHeight?n.css({width:Math.round(c)+"px"}):(n.css({width:Math.round(c)+"px",height:u>i.scaleMinHeight||"auto"===i.scaleMinHeight?Math.round(u)+"px":i.scaleMinHeight+"px"}),u=u>i.scaleMinHeight||"auto"===i.scaleMinHeight?u:i.scaleMinHeight,n.data("newSH",u)),!n.data("setup")||i.carousel&&i.carouselVisible>1)return!1;var p=t.is("[data-image]")?"image":"video",f=t.is("[data-video-bkg]")?!0:!1,m=t.is("[data-video-ratio]")?parseFloat(t.data("video-ratio")):1.778;t.find("img, iframe, video, .mejs-container").not(".tms-caption img, .tms-caption iframe, .tms-caption video").each(function(){var e,n,s;if("image"===p?(e=a(this).width(),n=a(this).height()):"video"===p&&((!i.respectRatio&&!f||i.fullscreen&&!f)&&t.addClass("tms-video-no-ratio"),f?(e=i.fullwidth?u*m:c,n=i.fullwidth?u:c/m):(e=a(this).attr("width")&&c>a(this).attr("width")?a(this).attr("width"):c,n=e/m)),s=e/n,"image"===p&&i.fullscreen||i.forceFit||a(this).parent().is("[data-force-fit]")||"video"===p&&f){if(a(this).is("img")&&!a(this).data("loaded"))return!1;a(this).css(h>s?{width:!i.fullwidth||i.forceFit||a(this).parent().is("[data-force-fit]")?c+"px":"auto",height:Math.round(c/s)+"px",top:Math.round(-((c/s-u)/2))+"px",left:0}:{width:!i.fullwidth||i.forceFit||a(this).parent().is("[data-force-fit]")||f?Math.round(u*s)+"px":"auto",height:u+"px",top:0,left:Math.round(-((u*s-c)/2))+"px"})}else"video"===p&&a(this).css({width:Math.floor(e)+"px",height:Math.floor(n)+"px",top:Math.floor((u-n)/2)+"px",left:Math.floor((c-e)/2)+"px"})}),v(t,i)},v=function(t,e){var i=t.closest(".tm-slider-container"),n=i.data("newSW"),s=i.data("newSH"),r=i.data("refW"),o=i.data("refH");t.find(".tms-caption").each(function(){if(!e.captionScaling||e.carouselVisible>1||a(this).is("[data-no-scale]"))return!1;var t=a(this),i=t.data("x"),d=t.data("y"),l=t.data("w"),c=t.data("pt"),u=t.data("pr"),h=t.data("pb"),p=t.data("pl"),f=t.data("mt"),v=t.data("mr"),m=t.data("mb"),g=t.data("ml"),b=t.data("bt"),y=t.data("br"),w=t.data("bb"),x=t.data("bl"),S=t.data("fs"),z=0===t.data("lh")?S:t.data("lh"),T=t.is("[data-offsetx]")?parseFloat(t.data("offsetx")):0,F=t.is("[data-offsety]")?parseFloat(t.data("offsety")):0,C=0>n*(T/r)?n*(T/r):n*(T/r)>T?T:n*(T/r),P=0>s*(F/o)?n*(F/r):n*(F/r)>F?F:s*(F/o);e.fullwidth&&F>P&&0>P&&(P=F);var A;t.find("img, iframe, video").length&&(A=n*(l/r)>l?l:n*(l/r)>n?n:n*(l/r)),t.css(t.find("img").length||t.find("iframe, video").length?{width:A+"px",height:t.children("iframe, video").length?A/1.778+"px":"auto"}:{fontSize:n*(S/r)>S?S:n*(S/r)+"px",lineHeight:n*(z/r)>z?z+"px":n*(z/r)+"px",paddingTop:n*(c/r)>c?c:n*(c/r)+"px",paddingRight:n*(u/r)>u?u:n*(u/r)+"px",paddingBottom:n*(h/r)>h?h:n*(h/r)+"px",paddingLeft:n*(p/r)>p?p:n*(p/r)+"px",marginTop:n*(f/r)>f?f:n*(f/r)+"px",marginRight:n*(v/r)>v?v:n*(v/r)+"px",marginBottom:n*(m/r)>m?m:n*(m/r)+"px",marginLeft:n*(g/r)>g?g:n*(g/r)+"px",borderTopWidth:n*(b/r)>b?b:Math.ceil(n*(b/r))+"px",borderRightWidth:n*(y/r)>y?y:Math.ceil(n*(y/r))+"px",borderBottomWidth:n*(w/r)>w?w:Math.ceil(n*(w/r))+"px",borderLeftWidth:n*(x/r)>x?x:Math.ceil(n*(x/r))+"px",whiteSpace:"nowrap"}),t.css({top:"top"===d?0+P:"bottom"===d?s-t.outerHeight()-P:(s-t.outerHeight())/2+P+"px",left:"left"===i?0+C:"right"===i?n-t.outerWidth()-C:(n-t.outerWidth())/2+C+"px"})})},m=function(t,e){return e.carouselVisible>1?!1:(t.find(".tms-caption").not(".no-transition").each(function(){var t=a(this),e=t.data("o")?parseFloat(t.data("o")):0,i=t.data("tx")?parseFloat(t.data("tx")):0,n=t.data("ty")?parseFloat(t.data("ty")):0,s=t.data("tz")?parseFloat(t.data("tz")):0,r=t.data("rx")?parseFloat(t.data("rx")):0,o=t.data("ry")?parseFloat(t.data("ry")):0,d=t.data("rz")?parseFloat(t.data("rz")):0,l=t.data("s")?parseFloat(t.data("s")):1;t.css(C?{transition:"none",transform:"translate3d("+i+"px, "+n+"px, "+s+"px)rotate3d( 1, 0, 0, "+r+"deg)rotate3d( 0, 1, 0, "+o+"deg)rotate3d( 0, 0, 1, "+d+"deg)scale3d("+l+", "+l+", "+l+")",opacity:e}:{opacity:0})}),i)},g=function(t,e,n){if(!n.useVideoAPI||n.carouselVisible>1)return!1;var s;try{if(t.find("iframe").length){s="#"+t.find("iframe").attr("id");var r=a(s).attr("src");i!==r&&r.indexOf("vimeo")>-1?(s=$f(a(s)[0]),s.api("play"===e&&n.autoPlay?"play":"pause")):i!==r&&r.indexOf("youtu")>-1&&(s=s.replace("#",""),"play"===e&&n.autoPlay?b[s].playVideo():b[s].stopVideo())}else t.find("video").length&&(s="#"+t.find("video").attr("id"),"play"===e&&n.autoPlay?a(s)[0].play():a(s)[0].pause())}catch(o){}},b={},y=!1,w=!1,x=function(n,s){if(!s.useVideoAPI||s.carouselVisible>1)return!1;var r=n.attr("src"),o=new Date;if(n.attr("id","video-"+o.getTime()),i!==r&&r.indexOf("vimeo")>-1){if(n.attr("src",n.attr("src")+"&player_id="+n.attr("id")).addClass("vimeo"),!y){y=!0;var d=t.createElement("script");d.src="http://a.vimeocdn.com/js/froogaloop2.min.js";var l=t.getElementsByTagName("script")[0];l.parentNode.insertBefore(d,l)}n.on("load",function(){var t="#"+a(this).attr("id"),e=$f(a(t)[0]),i=a(this).closest("li").is(":first-child")?!0:!1;e.addEvent("ready",function(){i&&s.autoPlay&&e.api("play"),e.addEvent("finish",function(){s.replayOnEnd&&e.api("play")})})})}else if(i!==r&&r.indexOf("youtu")>-1){if(n.addClass("youtube"),!w){w=!0;var c=t.createElement("script");c.src="http://www.youtube.com/player_api";var u=t.getElementsByTagName("script")[0];u.parentNode.insertBefore(c,u)}var h=function(){a(".youtube").each(function(){var t=a(this).attr("id"),e=a(this).closest("li").is(":first-child")?!0:!1;b[t]=new YT.Player(t,{events:{onStateChange:function(a){a.data===YT.PlayerState.ENDED&&s.replayOnEnd&&b[t].playVideo()},onReady:function(){e&&s.autoPlay&&b[t].playVideo()}}})})};e.onYouTubePlayerAPIReady=function(){h()}}else if(n.is("video")){var p=t.getElementById(n.attr("id")),f=n.closest("li").is(":first-child")?!0:!1;f&&s.autoPlay&&(p.load(),p.autoplay=!0),n.parent().is("[data-video-bkg]")&&(p.muted=s.muteBkgVideo),s.replayOnEnd&&(p.loop=!0)}},S=function(){var a={};return function(t,e,i){i||(i="id"),a[i]&&clearTimeout(a[i]),a[i]=setTimeout(t,e)}}();e.isRetinaDevice=function(){var a="(-webkit-min-device-pixel-ratio: 1.5), (min--moz-device-pixel-ratio: 1.5), (-o-min-device-pixel-ratio: 3/2), (min-resolution: 1.5dppx)";return this.devicePixelRatio>1||this.matchMedia&&this.matchMedia(a).matches?!0:!1};var z,T=t.body||t.documentElement,F=T.style,C=F.transition!==i||F.WebkitTransition!==i||F.MozTransition!==i||F.MsTransition!==i||F.OTransition!==i,P=["WebkitTransform","MozTransform","OTransform","msTransform"];for(var A in P)F[P[A]]!==i&&(z="-"+P[A].replace("Transform","").toLowerCase());var O=z+"-transform",V="webkitTransitionEnd otransitionend oTransitionEnd msTransitionEnd transitionend",H={linear:"cubic-bezier(0, 0, 1, 1)",swing:"cubic-bezier(0.42, 0, 0.58, 1)",easeOutCubic:"cubic-bezier(.215,.61,.355,1)",easeInOutCubic:"cubic-bezier(.645,.045,.355,1)",easeInCirc:"cubic-bezier(.6,.04,.98,.335)",easeOutCirc:"cubic-bezier(.075,.82,.165,1)",easeInOutCirc:"cubic-bezier(.785,.135,.15,.86)",easeInExpo:"cubic-bezier(.95,.05,.795,.035)",easeOutExpo:"cubic-bezier(.19,1,.22,1)",easeInOutExpo:"cubic-bezier(1,0,0,1)",easeInQuad:"cubic-bezier(.55,.085,.68,.53)",easeOutQuad:"cubic-bezier(.25,.46,.45,.94)",easeInOutQuad:"cubic-bezier(.455,.03,.515,.955)",easeInQuart:"cubic-bezier(.895,.03,.685,.22)",easeOutQuart:"cubic-bezier(.165,.84,.44,1)",easeInOutQuart:"cubic-bezier(.77,0,.175,1)",easeInQuint:"cubic-bezier(.755,.05,.855,.06)",easeOutQuint:"cubic-bezier(.23,1,.32,1)",easeInOutQuint:"cubic-bezier(.86,0,.07,1)",easeInSine:"cubic-bezier(.47,0,.745,.715)",easeOutSine:"cubic-bezier(.39,.575,.565,1)",easeInOutSine:"cubic-bezier(.445,.05,.55,.95)",easeInBack:"cubic-bezier(.6,-.28,.735,.045)",easeOutBack:"cubic-bezier(.175, .885,.32,1.275)",easeInOutBack:"cubic-bezier(.68,-.55,.265,1.55)",easeFastSlow:"cubic-bezier(.11,.69,.66,1.01)",easeBounceBack:"cubic-bezier(.18,1.92,.59,1.33)",easeBounceBackHard:"cubic-bezier(.8,1.91,0,.94)",easeHickUp:"cubic-bezier(.28,1.78,.01,0)"},I=!1;(navigator.userAgent.match(/Android/i)||navigator.userAgent.match(/webOS/i)||navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i)||navigator.userAgent.match(/iPod/i)||navigator.userAgent.match(/BlackBerry/i)||navigator.userAgent.match(/Windows Phone/i))&&(I=!0),a.fn.avalancheSlider=function(t){return this.each(function(){var e=a(this);if(!e.data("avalancheSlider")){var i=new o(this,t);e.data("avalancheSlider",i)}})},a.fn.avalancheSlider.tmsOpts={animation:"slide",easing:"easeInOutQuint",speed:700,navArrows:!0,navPagination:!0,navShowOnHover:!0,paginationType:"bullets",navKeyboard:!0,forceFit:!1,fullwidth:!1,fullscreen:!1,externalPadding:0,scaleUnder:1140,scaleMinHeight:214,captionScaling:!0,carousel:!1,carouselVisible:1,carouselScaleHeight:!1,autoAdvance:!0,showProgressBar:!0,interval:6e3,pauseOnHover:!0,useVideoAPI:!0,autoPlay:!0,replayOnEnd:!0,respectRatio:!0,muteBkgVideo:!1,lazyLoad:!0,retinaSupport:!1,retinaSupportMobile:!1,retinaSuffix:"",onSetup:null,onLoadEnd:null,onSlideBefore:null,onSlideAfter:null,onSlideshowStart:null,onSlideshowPause:null,onSlideshowEnd:null}}(jQuery,document,window);
/**
*	Summit Lightbox
*	Version: 1.0
*/
